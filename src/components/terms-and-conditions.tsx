...
export default function TermsAndConditions() {
  return (
    <div style={{ marginTop: 100 }}>
      ...
      <ul>
        ...
        <li>
          <p>
            ...
            this Agreement) refers to Problem Timing Status.
          </p>
        </li>
        <li>
          <p>
        ...
        <li>
          <p>
            <strong>Website</strong> refers to Problem Timing Status, accessible
            from{' '}
            <a
              href="https://mahmoudacm.github.io/problem-timing-status/"
              rel="noreferrer"
              target="_blank"
            >
              https://mahmoudacm.github.io/problem-timing-status/
            </a>
          </p>
        </li>
        <li>
      ...
      <ul>
        <li>By email: mahmoud.acm.123@gmail.com</li>
      </ul>
    </div>
  );
}
